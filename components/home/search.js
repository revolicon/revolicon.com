function Input() {
  return (
    <label className="w-full h-16 flex items-center space-x-4 border-2 border-neutral-100 rounded-full overflow-hidden bg-neutral-50 px-6">
      ...
      <input className="w-full h-full focus:outline-none outline-none font-medium text-neutral-500 placeholder:text-neutral-400 text-lg flex-1" type="text" placeholder="Search 8,023 icons across all categories"/>
    </label>
  )
}
